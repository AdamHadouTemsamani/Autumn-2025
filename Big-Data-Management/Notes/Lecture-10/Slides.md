...
**Efficiency**:
* How many resources do I need for a task?
...
* AMD: maximum cooling power required
![alt text](images/tdp.png)

**Performance vs. Efficiency**: Performance is how fast a task is done; efficiency is the resources required. Hardware has improved performance (3x) more than energy efficiency (1.45x) in recent years

**Carbon Footprint** (life cycle of a cloud server):
* Server footprint = embodied + operational
* **Operational**: The footprint from using the hardware. Calculated as $(Energy \times Carbon Intensity)$ 
...
* The grams of CO2 equivalent released per kWh of electricity. This varies heavily by location and energy source (e.g., coal vs. wind)
...
* Energy and hardware emissions
  * Energy needed for ML computations + embodied emissions associated with hardware
...
**Loss of privacy**
* Living in a surveillance economy
* Personal data is:
